import { Users, CheckCircle2, Award, ArrowLeft } from 'lucide-react';
...
export function DepartmentTriageStep({
  briefLevel,
  leadDepartment,
  ...
  const handlePracticeSelect = (dept: string) => {
    ...
    onSupportingDepartmentsChange([]); // Clear supporting departments
  };
        ...
        <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              <p className="text-sm font-semibold text-yellow-900 mb-2">Recommended Practice Area</p>
            ...
            <div className="pt-4 border-t border-gray-200">
              <p className="text-xs text-gray-600">
                <strong>Note:</strong> You can change the practice assignment at any time by selecting a different option from the list.
              </p>
            </div>
          </div>
        </div>
