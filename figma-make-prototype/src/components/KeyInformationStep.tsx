...
export function KeyInformationStep({ keyInfo, onNext, onEdit, onBack }: KeyInformationStepProps) {
  const fields = [
    ...
    { key: 'jobToBeDone' as const, label: 'Job to be Done', icon: Briefcase, placeholder: 'Description of work' },
    { key: 'budget' as const, label: 'Budget', icon: DollarSign, placeholder: 'Total campaign budget' },
    { key: 'dueDate' as const, label: 'Due Date', icon: Calendar, placeholder: 'YYYY-MM-DD', type: 'date' }
  ];
